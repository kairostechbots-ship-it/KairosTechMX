      ...
      <section className="py-24 px-6 bg-white border-y border-slate-100 mt-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <FaqItem q="¿Trabajan con cualquier tipo de empresa o rubro?" a="Sí. Hemos colaborado con agencias de bienes raíces, clínicas médicas, e-commerce, sector automotriz, despachos legales y una gran variedad de comercios y servicios B2B y B2C." />
